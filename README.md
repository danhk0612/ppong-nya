...
퐁냐는 작혼(雀魂, Mahjong Soul) 전적, 랭킹, 통계를 한국어 중심으로 확인하고 관리하기 위한 SvelteKit 기반 웹 서비스입니다. 현재 MVP는 Google OAuth 로그인, 사용자별 대국 기록/설정/즐겨찾기/메모 저장, 모바일 우선 UI를 중심으로 구성되어 있습니다.
