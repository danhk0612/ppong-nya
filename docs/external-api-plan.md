...
`src/data/source/records/loader.ts`에서 현재 사용하는 모든 upstream 퐁냐(ppong-nya)
데이터 endpoint를 정리하고, 신규 퐁냐에서 각 endpoint를 외부 API로 계속
...
| Endpoint 패턴                                                           | 현재 출처                        | 신규 퐁냐 결정                                                  | 캐시 여부                | 대상 테이블                               |
| ----------------------------------------------------------------------- | -------------------------------- | --------------------------------------------------------------- | ------------------------ | ----------------------------------------- |
